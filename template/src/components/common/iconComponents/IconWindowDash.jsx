...
export const IconWindowDash = forwardRef(({
    ...
    return (
        ...
        >
            ...
            <path d="M16 12.5a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0zm-5.5 0a.5.5 0 00.5.5h3a.5.5 0 000-1h-3a.5.5 0 00-.5.5z" />
        </svg>
    );
});

IconWindowDash.propTypes = {
    color: PropTypes.string,
    size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
    title: PropTypes.string,
};

IconWindowDash.defaultProps = {
    color: 'currentColor',
    size: '1em',
    title: null,
};
